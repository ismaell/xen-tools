...
# rise with zypper ( opensuse based ) require  valid user base for the rpm installs
# without you get many errors with i.e " unknown user root / invalid user or group shadow ..."
